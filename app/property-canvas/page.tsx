      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 pt-32 md:pt-40 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-6">
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-xs font-black uppercase tracking-[0.4em] text-purple-400">
                Archive
              </span>
            </div>
        ...
        {savedProperties.length === 0 ? (
          <div className="w-full bg-[#581c87]/10 border border-purple-500/20 backdrop-blur-md p-12 text-center shadow-2xl">
            ...
            <a
              href="/"
              className="inline-block bg-[#7c3aed] hover:bg-[#6d28d9] transition text-white px-6 py-3 text-sm font-semibold shadow-lg"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {savedProperties.map((prop) => {
              ...
              return (
                <div
                  key={prop.id}
                  className="group bg-[#581c87]/20 backdrop-blur-md border border-purple-500/20 hover:border-purple-500/50 transition-all duration-500 overflow-hidden shadow-2xl flex flex-col"
                >
                  {/* Image Block */}
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                    ...
                    <div className="grid grid-cols-3 gap-2 mt-auto border-t border-purple-500/20 pt-4">
                      <div>
                        <span className="block text-[9px] uppercase tracking-widest text-gray-500 font-bold mb-1 flex items-center gap-1">
                      ...
                      <div>
                        ...
                        <span className="text-xs font-mono text-gray-200 mt-0.5 block">
                          {prop.date}
                        </span>
                      </div>
                    </div>
